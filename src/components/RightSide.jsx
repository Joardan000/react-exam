                ...
                <div
                    ...
                    <div className="pt-2 px-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <p className="font-semibold">{sideData.login}</p>
                    ...
                    <div className="py-2">
                        ...
                        <div className="flex flex-col">
                            {
                                rightSide1.map((item) => (
                                    <a className="p-2 cursor-pointer flex items-center gap-2 w-full rounded-[6px] hover:bg-[rgba(101_108_118/0.15)]" href={item.url}>
